...
st.markdown(f"""
    ...
    .message-text {{ font-size: 1.18rem; line-height: 1.5; font-weight: 450; white-space: pre-wrap; color: {text_main_color} !important; }}
